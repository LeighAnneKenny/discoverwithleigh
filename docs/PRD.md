...
5. 📨 *Handed to Leigh 2026-07-07 — no site code; configured in the WhatsApp Business app on the phone holding +27 72 227 7016.* **WhatsApp auto-response.** (Added 2026-07-06.) Two features under Settings → Business tools, official guides:
